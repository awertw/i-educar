...
class Portabilis_View_Helper_DynamicInput_ProfesorComponente extends Portabilis_View_Helper_DynamicInput_CoreSelect
{
    protected function inputName()
    {
        return 'ref_cod_ptofessor_componente';
    }
