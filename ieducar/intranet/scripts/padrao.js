...
function pesquisa_valores_popless(caminho, campo)
{
  ...
  if (host.indexOf('?') === -1) {
    showExpansivel(1024, 480, '<iframe src="' + host + '?campo=' + campo + '&div=' + div + '&popless=1" frameborder="0" height="100%" width="100%" marginheight="0" marginwidth="0" name="temp_win_popless"></iframe>', 'Pesquisa de valores');
  }
  else {
    showExpansivel(1024, 480, '<iframe src="' + host + '&campo=' + campo + '&div=' + div + '&popless=1" frameborder="0" height="100%" width="100%" marginheight="0" marginwidth="0" name="temp_win_popless"></iframe>', 'Pesquisa de valores');
  }
