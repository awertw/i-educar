$j(function () {
    let consulta = {
        ...
        makeTable: function (data) {
            ...
            html +=
                '<tr><td class="formdktd">&nbsp;</td><td class="formdktd">Nome</td><td class="formdktd">Turma</td></tr>';

            $j.each(data, function (i, v) {
                html += "<tr>";
                html +=
                    '<td class="formmdtd"><a href="/intranet/educar_matricula_det.php?cod_matricula=' +
                    v.cod_matricula +
                    '">' +
                    (i + 1) +
                    "</a></td>";
