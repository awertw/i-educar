...
return new class extends clsDetalhe {
    ...
    public function Gerar()
    {
        ...
        if (!$registro) {
            $this->simpleRedirect(sprintf(
                'educar_coordenacao_falta_atraso_professor_lst.php?ref_cod_instituicao=%d',
        ...
        if ($obj_permissoes->permissao_cadastra(635, $this->pessoa_logada, 7)) {
            ...
            $this->url_editar   = sprintf(
                'educar_coordenacao_falta_atraso_professor_cad.php?cod_falta_atraso=%d',
    ...
    {
        $this->title = 'Coordenação - Falta/Atraso do Servidor';
        $this->processoAp = 635;
    }
};
