...
HTML;
    ...
    public function RenderHTML()
    {
        ...
        if ($this->tituloFormResultado) {
            $retorno .=  "
                <tr>
                    <td class='formdktd' colspan=\"$ncols\" height='24'><span class='form colorFont'><b>{$this->tituloFormResultado}</b></span></td>
                </tr>";
        }
        ...
        if (!empty($this->camposResultado)) {
            ...
            while (list($nome, $componente) = each($this->camposResultado)) {
                if ($componente[0] != 'oculto') {
                    ...
                    $retorno .= "
                        <tr>
                            <td class='$classe' valign='top'><span class='form colorFont'>$campo</span></td>
                            <td class='$classe' valign='top'>
                            <span class='form colorFont'>";
