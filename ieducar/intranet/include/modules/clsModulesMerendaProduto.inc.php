...
class clsModulesMerendaProduto extends Model
{
    public $id;
    public $unidade;
    public $descricao;
    ...
    public function __construct(
        ...
        $this->_tabela = "{$this->_schema}merenda_produto";

        $this->_from = "
            modules.merenda_produto as merenda_produto
        ";

        $this->_campos_lista = $this->_todos_campos = '
            merenda_produto.id,
            merenda_produto.unidade,
            merenda_produto.descricao
    ...
    {
        $sql = "SELECT * FROM modules.merenda_produto";
        $db = new clsBanco();
        $countCampos = count(explode(',', $this->_campos_lista));
        $resultado = [];
        $filtros = '  ';
        ...
        $this->_total = $db->CampoUnico("SELECT COUNT(0) FROM modules.merenda_produto");
