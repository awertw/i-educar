...
class clsCadastro extends clsCampos
{
    ...
    public function RenderHTML()
    {
        ...
        $retorno .= "\n<div class='tablecadastro' style='line-height: 2.31; '>\n";
        $applicationTitle = $this->titulo_aplication ?? '';
        $titulo = isset($this->titulo) ? $this->titulo : "{$this->tipoacao} {$applicationTitle}";
        ...
        if (empty($this->campos)) {
            $retorno .= '<div><div class=\'linhaSim\' ><span class=\'form\'>N&atilde;o existe informa&ccedil;&atilde;o dispon&iacute;vel</span></div></div>';
        } else {
            // Verifica se houve erros no controller
            $retorno .= $this->_getControllerErrors();
            $retorno .= $this->MakeCampos();
        ...
        $retorno .=
            '<div><div class=\'tableDetalheLinhaSeparador\'></div></div>
    <div class=\'linhaBotoes\'></div >
    <script type="text/javascript">
    var goodIE = (document.all) ? 1:0;
    var netscape6 = (document.getElementById && !document.all) ? 1:0;
    var aux = \'\';
