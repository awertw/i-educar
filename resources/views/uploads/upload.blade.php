                ...
                @foreach ($files as $file)
                    <div>
                        <span id="file_info{{ $file->id }}">
                            ...
                            <a class="decorated" id="link_delete_file_{{ $file->id }}"
                                style="cursor: pointer; margin-left: 10px;">Excluir</a>
                            <a class="decorated" id="link_view_file_{{ $file->id }}" target="_blank"
                                href="{{ $file->url }}" style="cursor: pointer; margin-left: 10px;">Visualizar</a>
                        </span>
                    </div>
                @endforeach
            @endif
            <input @if ($disabled) disabled @endif class="inputfile inputfile-buttom" name="file"
                id="file" type="file" size="40" value="">
            <label id="file" for="file"><strong>Escolha um arquivo</strong></label>&nbsp;<br>
